...
// RedeemWinnings is a paid mutator transaction binding the contract method 0xffc28113.
//
// Solidity: function redeemWinnings(string lobbyId) returns(bool)
func (_Contracts *ContractsTransactor) RedeemWinnings(opts *bind.TransactOpts, lobbyId string) (*types.Transaction, error) {
	return _Contracts.contract.Transact(opts, "redeemWinnings", lobbyId)
}

// RedeemWinnings is a paid mutator transaction binding the contract method 0xffc28113.
//
// Solidity: function redeemWinnings(string lobbyId) returns(bool)
func (_Contracts *ContractsSession) RedeemWinnings(lobbyId string) (*types.Transaction, error) {
	return _Contracts.Contract.RedeemWinnings(&_Contracts.TransactOpts, lobbyId)
}

// RedeemWinnings is a paid mutator transaction binding the contract method 0xffc28113.
//
// Solidity: function redeemWinnings(string lobbyId) returns(bool)
func (_Contracts *ContractsTransactorSession) RedeemWinnings(lobbyId string) (*types.Transaction, error) {
	return _Contracts.Contract.RedeemWinnings(&_Contracts.TransactOpts, lobbyId)
}
